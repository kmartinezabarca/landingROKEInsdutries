...
const allConsultingServices: ConsultingService[] = [
  {
...
const rokeLabsServices: ConsultingService[] = [
  {
    iconName: "CircuitBoard",
    title: "Fabricación de PCBs a Medida",
    description:
      "Prototipado rápido de placas de circuito impreso (PCBs) de una o dos capas, fresadas con precisión en nuestra maquinaria CNC.",
    features: [
      "Fresado de Alta Precisión",
      "Perforación y Corte a Medida",
      "Ideal para Prototipos y Lotes Pequeños",
      "Tiempos de Entrega Rápidos (24-48h)",
    ],
  },
  {
    iconName: "Printer",
    ...
    description:
      "Materializa tus diseños. Ofrecemos servicios de impresión 3D de alta resolución para piezas funcionales, carcasas y prototipos.",
    features: [
      "Tecnología FDM de Alta Calidad",
      "Amplia Gama de Materiales (PLA, PETG, ABS)",
      "Optimización de Diseño para Fabricación (DFM)",
  ...
  },
  {
    ...
    description:
      "Te ayudamos a diseñar y construir tus propios productos de hardware. Desde la elección de componentes hasta la integración de firmware.",
    features: [
      "Diseño de Sistemas Embebidos (Arduino/ESP32)",
      "Integración de Sensores y Actuadores",
      "Diseño Mecánico para CNC y 3D",
...
const ServicesPage: React.FC = () => {
  ...
  const isError =
    isErrorCategories || isErrorServicePlans || isErrorBillingCycles;
            ...
            >
              <div className="order-2 lg:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <img
                    src={`/assets/images/services/${currentCategory.slug}.png`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredPlans.map((plan) => (
                    ...
                    >
                      ...
                      <h4 className="text-2xl font-bold text-foreground mb-2 text-center">
                        {plan.name}
                      </h4>
