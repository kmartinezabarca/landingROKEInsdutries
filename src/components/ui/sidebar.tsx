...
interface SidebarGroupLabelProps extends React.HTMLAttributes<HTMLDivElement> { asChild?: boolean }
...
interface SidebarGroupActionProps extends React.HTMLAttributes<HTMLButtonElement> { asChild?: boolean }
...
interface SidebarMenuSkeletonProps extends React.HTMLAttributes<HTMLDivElement> { showIcon?: boolean }
